...
private:
	...
	int UILuaCall(lua_State* luaState);
...
public:
	...
	BOOL CallLuaFuncByIndex(int nIndex, const char* szVMName);
	BOOL CallLuaFunc(const std::string& strPath, const std::string& strFuncName, const char* szVMName);
